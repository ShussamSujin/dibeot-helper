...
(function () {
  ...
  function hwpxBlob(blocks, landscape, title) {
    ...
    const hpf = XDECL + '<opf:package' + HWP_NS + ' version="" unique-identifier="" id="">' +
      ...
      '<opf:meta name="creator" content="text">디벗 업무 도우미</opf:meta>' +
    ...
    const version = XDECL +
      ...
      ' application="디벗 업무 도우미" appVersion="1.0"/>';
  ...
  function renderHome() {
    ...
    h += '<section class="hero">' +
         ...
         '<p>디벗 담당 교사가 자주 찾는 업무를 절차와 서식으로 정리했습니다. 위쪽 메뉴에서 업무를 고르면 준비물, 절차 체크리스트, 내려받을 서식이 함께 나옵니다.</p>' +
         '<div class="hero-meta">' +
